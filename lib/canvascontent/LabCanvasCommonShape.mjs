...
export class LabCanvasCommonShape extends LabCanvasContent {
     ...
     * @param {number} width The width of the rectangle, mandatory when sides
     ...
     *      be used)
     * @param {number} height The height of the rectangle, mandatory when 
     *      sides are not equal, and ignored when they are (hint: pass null if
     ...
     *      coordinate system (default: 0, which is the canvas center)
     * @param {number} [angle=0] The inclination angle (default: 0, which is
     *      a perfect horizontal disposition)
