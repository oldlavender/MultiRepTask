...
export class LabCanvasContent {
     ...
     * @param {boolean} spread If true, spreads the link to the content (s)
     *      so they are all inter-linked.
     */
    ...
    LinkProperty(prop, extcontent, spread=false, sync=false) {
        if (extcontent instanceof LabCanvasContent) {
            ...
            for (let cont of extcontent) {
                ...
                var spreadlink = extcontent.filter((item) => cont!=item);
                spreadlink.push(this);
                this.L
