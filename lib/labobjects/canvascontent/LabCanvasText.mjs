...
export class LabCanvasText extends LabCanvasContent {
     ...
     */
    constructor(
        text, left=0, top=0, textAlign=undefined, fontSize=undefined,
        lineHeight=undefined, fontWeight=undefined, fontStyle=undefined, 
        fontFamily=undefined, fill=undefined, id=undefined
    ) {
        /*
            .text
        ...
        */
       var values = {
        text, left, top, textAlign, fontSize, lineHeight, 
